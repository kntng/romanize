...
const HANGUL_INTERVALS: &[UnicodeInterval] = &[
    ...
    UnicodeInterval { start: 0x0000, end: 0x007F, block: UnicodeBlock::BasicLatin },
    // https://en.wikipedia.org/wiki/Hangul_Jamo
    // https://unicode.org/charts/PDF/U1100.pdf
    UnicodeInterval { start: 0x1100, end: 0x11FF, block: UnicodeBlock::HangulJamo },
    // https://en.wikipedia.org/wiki/CJK_Symbols_and_Punctuation
    // https://www.unicode.org/charts/PDF/U3000.pdf
    UnicodeInterval { start: 0x3000, end: 0x303F, block: UnicodeBlock::CjkSymbolsAndPunctuation },
    // https://en.wikipedia.org/wiki/Hangul_Compatibility_Jamo
    // https://www.unicode.org/charts/PDF/U3130.pdf
    UnicodeInterval { start: 0x3130, end: 0x318F, block: UnicodeBlock::HangulCompatibilityJamo },
    // https://en.wikipedia.org/wiki/Hangul_Jamo_Extended-A
    // https://www.unicode.org/charts/PDF/UA960.pdf
    UnicodeInterval { start: 0xA960, end: 0xA97F, block: UnicodeBlock::HangulJamoExtendedA },
    // https://en.wikipedia.org/wiki/Hangul_Syllables
    // https://www.unicode.org/charts/PDF/UAC00.pdf
    UnicodeInterval { start: 0xAC00, end: 0xD7A3, block: UnicodeBlock::HangulSyllables },
    // https://en.wikipedia.org/wiki/Hangul_Jamo_Extended-B
    // https://www.unicode.org/charts/PDF/UD7B0.pdf
    UnicodeInterval { start: 0xD7B0, end: 0xD7FF, block: UnicodeBlock::HangulJamoExtendedB },
];
...
impl UnicodeTree{
    ...
    pub fn is_char(&self, ch: char) -> bool {
        let code = ch as u32;
        self.intervals.iter().any(|i| i.start <= code && code <= i.end)
    }
...
pub const HANGUL_TREE: HangulTree = UnicodeTree::new(HANGUL_INTERVALS);
